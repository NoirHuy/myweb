<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cho.aspx.cs" Inherits="WTC.Cho" %>
...
<body>
    ...
    <div id="wp-products">
        <h2>Các Loài Và Giống Chó Tại Cửa Hàng</h2>
        <ul id="list-products">
            <!--Khu vuc truyen du lieu-->
            <asp:Repeater ID="RepeaterCho" runat="server">
                <ItemTemplate>
                    <div class="item">
