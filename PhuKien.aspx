<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PhuKien.aspx.cs" Inherits="WTC.WebForm2" %>
...
<body>
    ...
    <div id="wp-products">
        <h2>Các loại phụ kiện tại cửa hàng</h2>
        <ul id="list-products">
            <!--Khu vuc truyen du lieu-->
            <asp:Repeater ID="RepeaterPhuKien" runat="server">
                <ItemTemplate>
                    <div class="item">
